...
from keypad2 import numPadList, operatorList, constantList, functionList, constant_dic, function_dic
...
class Calculator(QWidget):
    ...
    def buttonClicked(self):
        ...
        if key == '=':
            ...
            self.display.clear()
        elif key in constant_dic:
            self.display.setText(self.display.text() + constant_dic[key])
        elif key in function_dic:
            self.display.setText(str(function_dic[key](self.display.text())))
        else:
