...
from keypad2 import numPadList, operatorList, constantList, constantValue, functionList, functionMap
...
class Calculator(QWidget):
    ...
    def buttonClicked(self):
        ...
        if key == '=':
            ...
            self.display.setText(self.display.text() + constantValue[constantList.index(key)][1])
